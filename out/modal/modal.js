...
;(function () {
  const CONTENT = {
    ...
    // TODO: Оставил на случай появления en версии
    en: {
  ...
  const title = CONTENT['ru'].title
  const text1 = CONTENT['ru'].text1
  const text2 = CONTENT['ru'].text2
  const text3 = CONTENT['ru'].text3
